 ...
 * Если браузер показывает "ClipboardReadWrite permission has been blocked" после многократного
 * отклонения запроса, разрешение можно сбросить в Page Info (иконка рядом с URL).
