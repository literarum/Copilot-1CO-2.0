    ...
    tables: [
        {
            ...
            items: [
                { code: '1000009', name: 'Оператор', in1C: '', desc: 'Уведомление об ошибке, возникшей в процессе подписки' },
                { code: '1000011', name: 'Оператор', in1C: '', desc: 'Уведомление об успешной доставке отправки' },
                { code: '1000014', name: 'Оператор', in1C: '', desc: 'Уведомление об ошибке' },
                { code: '1', name: 'Страхователь', in1C: '', desc: 'Подписка на оператора' },
                { code: '5', name: 'Фонд', in1C: '', desc: 'Получение сообщений по изменению статуса ЭЛН в МО' },
                { code: '6', name: 'Страхователь', in1C: '', desc: 'Подтверждение прочтения сообщения' },
                { code: '10', name: 'Фонд', in1C: '', desc: 'Извещение ПВСО' },
                { code: '11', name: 'Фонд', in1C: '', desc: 'Результат подтверждения прочтения сообщения' },
                { code: '14', name: 'Фонд', in1C: '', desc: 'Уведомление об ошибке' },
                { code: '15', name: 'Страхователь', in1C: '', desc: 'Заявление на ПОВЭД' },
                { code: '16', name: 'Фонд', in1C: '', desc: 'Уведомление об изменении статуса запроса на ПОВЭД' },
                { code: '27', name: 'Страхователь', in1C: '', desc: 'Запрос перечня документов, обрабатываемых СЭДО' },
                ...
                { code: '87', name: 'Фонд', in1C: '', desc: 'Результат регистрации сведений о застрахованном лице' },
                ...
                { code: '105', name: 'Фонд', in1C: '', desc: 'Результат обработки ответа на запрос' },
                { code: '106', name: 'Фонд', in1C: '', desc: 'Результат обработки уведомления' },
                { code: '107', name: 'Фонд', in1C: '', desc: 'Информирование о событиях по проактивному процессу по временной нетрудоспособности и материнству' },
                { code: '109', name: 'Страхователь', in1C: '', desc: 'Информация о жизненных событиях' },
                { code: '110', name: 'Фонд', in1C: '', desc: 'Уведомление о статусе выплаты пособия (с 06.10.2025 тип 11010)' },
                { code: '111', name: 'Фонд', in1C: '', desc: 'Уведомление об изменении статуса ЭЛН' },
                { code: '112', name: 'Фонд', in1C: '', desc: 'Результат обработки информации о жизненных событиях' },
                ...
                { code: '205', name: 'Страхователь', in1C: '', desc: 'Запрос справочника полномочий' },
                ...
                { code: '301', name: 'Фонд', in1C: 'Нет', desc: 'Решение о привлечении к ответственности по результатам камеральной проверки' },
                { code: '302', name: 'Фонд', in1C: 'Нет', desc: 'Решение об отказе в привлечении к ответственности по результатам камеральной проверки' },
                { code: '303', name: 'Фонд', in1C: 'Да', desc: 'Требование о представлении документов по камеральной проверке' },
                { code: '304', name: 'Фонд', in1C: 'Нет', desc: 'Решение о возмещении излишне понесенных расходов по результатам камеральной проверки' },
                { code: '305', name: 'Фонд', in1C: 'Нет', desc: 'Акт выездной проверки' },
                { code: '306', name: 'Фонд', in1C: 'Нет', desc: 'Решение о привлечении к ответственности по результатам выездной проверки' },
                { code: '307', name: 'Фонд', in1C: 'Нет', desc: 'Решение об отказе в привлечении к ответственности по результатам выездной проверки' },
                { code: '308', name: 'Фонд', in1C: 'Да', desc: 'Требование о представлении документов по выездной проверке' },
                { code: '309', name: 'Фонд', in1C: 'Нет', desc: 'Решение о возмещении излишне понесенных расходов по результатам выездной проверки' },
                { code: '310', name: 'Фонд', in1C: 'Нет', desc: 'Требование об уплате недоимки по страховым взносам, пеней и штрафов' },
                ...
                { code: '1000', name: 'Страхователь', in1C: '', desc: 'Ответ страхователя на обращение СФР' },
                { code: '1001', name: 'Фонд', in1C: '', desc: 'Обращение СФР к страхователю' },
                { code: '1010', name: 'Фонд', in1C: '', desc: 'Извещение о запросе недостающих сведений для назначения пособий по ВНиМ, ССВ' },
                { code: '11010', name: 'Фонд', in1C: '', desc: 'Уведомление о статусе выплаты возмещения расходов страхователю' },
                { code: '12010', name: 'Страхователь', in1C: '', desc: 'Заявление о возмещении расходов на оплату дополнительных выходных дней для ухода за детьми-инвалидами' },
                { code: '12110', name: 'Фонд', in1C: '', desc: 'Результат обработки заявления о возмещении расходов на оплату доп. выходных для ухода за детьми-инвалидами' },
                { code: '12210', name: 'Фонд', in1C: '', desc: 'Решение об отказе в возмещении расходов на оплату доп. выходных для ухода за детьми-инвалидами' },
            ],
        },
        {
            ...
            items: [
                ...
                { code: '88', name: 'Информация о несоответствии сведений о застрахованном лице', in1C: 'Документ Несоответствие сведений о застрахованном лице (СЭДО СФР) (Кадры – Пособия – Застрахованные лица (СЭДО))' },
                { code: '100', name: 'Запрос на проверку, подтверждение, корректировку сведений проактивной выплаты', in1C: 'Документ Входящий запрос СФР для расчета пособия (Кадры – Пособия – Входящие запросы СФР для расчета пособий)' },
                { code: '105', name: 'Результат обработки ответа на запрос', in1C: 'Протокол приема в документе Ответ на запрос СФР для расчета пособия (Кадры – Пособия – Ответы на запросы СФР для расчета пособий)' },
                { code: '106', name: 'Результат обработки уведомления о прекращении отпуска', in1C: 'Протокол приема в документе Уведомление о прекращении отпуска по уходу за ребенком (Кадры – Пособия – Уведомления о прекращении отпуска по уходу за ребенком)' },
                { code: '107', name: 'Информирование о событиях по проактивному процессу по ВНиМ', in1C: 'Регистр Входящие сообщения СЭДО СФР (бывш. ФСС)' },
                { code: '110', name: 'Уведомление о статусе выплаты пособия', in1C: 'Регистр Входящие сообщения СЭДО СФР (бывш. ФСС)' },
                { code: '111', name: 'Уведомление об изменении ЭЛН', in1C: 'Рабочее место Сообщения ФСС об изменении ЭЛН (Кадры – Пособия)' },
                { code: '112', name: 'Результат обработки информации о жизненных событиях', in1C: 'Регистр Входящие сообщения СЭДО СФР (бывш. ФСС)' },
                { code: '321', name: 'Результат обработки запроса страхователя о получении от Фонда сведений о заработной плате', in1C: 'Документ Средний заработок по данным СФР (СЭДО) (Кадры – Пособия)' },
                { code: '322', name: 'Сведения для исчисления первых трех дней пособия по ВНиМ', in1C: 'Кадры – Пособия – Извещения СФР и уведомления о выплате пособий; документ «Данные СФР для расчета пособия»' },
            ],
        },
        {
            ...
            codeField: 'code',
            items: [
                { code: '86', name: 'Сведения о застрахованном лице', in1C: 'Документ Сведения о застрахованном лице (СЭДО) (Кадры – Пособия – Застрахованные лица (СЭДО))' },
                { code: '101', name: 'Ответ на запрос проверки, подтверждения, корректировки сведений проактивной выплаты', in1C: 'Документ Ответ на запрос СФР для расчета пособия (Кадры – Пособия – Ответы на запросы СФР для расчета пособий)' },
                { code: '104', name: 'Уведомление о прекращении отпуска по уходу за ребенком', in1C: 'Документ Уведомление о прекращении отпуска по уходу за ребенком (Кадры – Пособия – Уведомления о прекращении отпуска по уходу за ребенком)' },
                { code: '109', name: 'Информация о жизненных событиях', in1C: 'Документ Исходящее сообщение о страховом случае СФР (Кадры – Пособия – Исходящие сообщения о страховых случаях СФР)' },
                { code: '320', name: 'Запрос страхователя о получении от Фонда сведений о заработной плате застрахованного лица', in1C: 'Документ Запрос данных СФР о среднем заработке (Кадры – Пособия – Запросы данных СФР о среднем заработке)' },
            ],
        },
        {
            ...
            codeField: 'code',
            items: [
                { code: '300', name: 'Акт камеральной проверки', in1C: 'Рабочее место 1С-Отчетность (Отчетность, справки – 1С-Отчетность – Входящие – Требования и уведомления)' },
                { code: '301', name: 'Решение о привлечении к ответственности по результатам камеральной проверки', in1C: 'Одноименные документы в 1С-Отчетность – Входящие – Требования и уведомления' },
                { code: '302', name: 'Решение об отказе в привлечении к ответственности по результатам камеральной проверки', in1C: 'Там же' },
                { code: '303', name: 'Требование о представлении документов по камеральной проверке', in1C: 'Там же' },
                { code: '304', name: 'Решение о возмещении излишне понесенных расходов по результатам камеральной проверки', in1C: 'Там же' },
                { code: '305', name: 'Акт выездной проверки', in1C: 'Там же' },
                { code: '306', name: 'Решение о привлечении к ответственности по результатам выездной проверки', in1C: 'Там же' },
                { code: '307', name: 'Решение об отказе в привлечении к ответственности по результатам выездной проверки', in1C: 'Там же' },
                { code: '308', name: 'Требование о представлении документов по выездной проверке', in1C: 'Там же' },
                { code: '309', name: 'Решение о возмещении излишне понесенных расходов по результатам выездной проверки', in1C: 'Там же' },
                { code: '310', name: 'Требование об уплате недоимки по страховым взносам, пеней и штрафов', in1C: 'Там же' },
                { code: '311', name: 'Решение о взыскании', in1C: 'Там же' },
                { code: '312', name: 'Требование о возмещении излишне понесенных расходов', in1C: 'Там же' },
                { code: '315', name: 'Уведомление о приеме (отказе в приеме) по камеральной проверке', in1C: 'Ссылка в документе Ответ на требование СФР (бывш. ФСС) (Отчетность, справки – 1С-Отчетность – Письма)' },
                { code: '316', name: 'Уведомление о приеме (отказе в приеме) по выездной проверке', in1C: 'Там же' },
                { code: '318', name: 'Результат регистрации заявления на формирование справки о расчетах', in1C: 'Этапы отправки в документе Запрос на сверку: Справка о расчетах (Отчетность, справки – 1С-Отчетность – Сверки)' },
                { code: '319', name: 'Справка о расчетах', in1C: 'Справка о расчетах в документе Запрос на сверку: Справка о расчетах (Отчетность, справки – 1С-Отчетность – Сверки)' },
            ],
        },
        {
            ...
            codeField: 'code',
            items: [
                { code: '313', name: 'Ответ страхователя на запрос документов по камеральной проверке', in1C: 'Документ Ответ на требование СФР (бывш. ФСС) (Отчетность, справки – 1С-Отчетность – Письма)' },
                { code: '314', name: 'Ответ страхователя на запрос документов по выездной проверке', in1C: 'Там же' },
                { code: '317', name: 'Заявление на формирование справки о расчетах', in1C: 'Документ Запрос на сверку: Справка о расчетах (Отчетность, справки – 1С-Отчетность – Сверки)' },
            ],
        },
    ],
};
    ...
    if (data.tables && Array.isArray(data.tables)) {
        ...
        data.tables.forEach((tableData, tableIndex) => {
            ...
            if (!tableData.items || tableData.items.length === 0) {
                ...
                const fields =
                    tableData.fields || ['code', 'name', 'in1C', 'desc'].slice(0, Math.max(3, colLen));
