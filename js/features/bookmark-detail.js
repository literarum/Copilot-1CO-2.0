...
export async function showBookmarkDetailModal(bookmarkId) {
                        ...
                        <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center flex-shrink-0">
                                    ...
                                    <button id="${deps.bookmarkDetailModalConfig.buttonId}" type="button" class="inline-block p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors align-middle" title="Развернуть на весь экран">
    ...
    const fullscreenBtn = modal.querySelector('#' + deps.bookmarkDetailModalConfig.buttonId);
    if (fullscreenBtn) {
            ...
            fullscreenBtn.addEventListener('click', () => {
                if (typeof deps.toggleModalFullscreen === 'function') {
                    deps.toggleModalFullscreen(
                        deps.bookmarkDetailModalConfig.modalId,
                        deps.bookmarkDetailModalConfig.buttonId,
                        deps.bookmarkDetailModalConfig.classToggleConfig,
                        deps.bookmarkDetailModalConfig.innerContainerSelector,
                        deps.bookmarkDetailModalConfig.contentAreaSelector,
                    );
                } else {
            ...
            if (bookmark.screenshotIds && bookmark.screenshotIds.length > 0) {
                ...
                try {
                    ...
                    if (bookmarkScreenshots.length > 0) {
                        if (typeof deps.renderScreenshotThumbnails === 'function') {
